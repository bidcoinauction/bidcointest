                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-300 text-sm">Save up to 30% compared to regular BidPack purchases</p>
                      </div>
                    </li>
                    <li className="flex items-start">
                      <div className="bg-primary/20 p-2 rounded-full mr-3 mt-0.5">
                      ...
                      <div>
                        ...
                        <p className="text-gray-300 text-sm">Automatically receive fresh bids each month</p>
                      </div>
                    </li>
                    <li className="flex items-start">
                      <div className="bg-primary/20 p-2 rounded-full mr-3 mt-0.5">
                      ...
                      <div>
                        ...
                        <p className="text-gray-300 text-sm">Get early access to high-demand auctions and drops</p>
                      </div>
                    </li>
                    <li className="flex items-start">
                      <div className="bg-primary/20 p-2 rounded-full mr-3 mt-0.5">
                      ...
                      <div>
                        ...
                        <p className="text-gray-300 text-sm">Upgrade, downgrade, or cancel your subscription anytime</p>
                      </div>
                    </li>
                  </ul>
                </div>
