...
export default function ActivityPage() {
  ...
  const filteredActivities = activities?.filter(activity => {
    ...
    const matchesType = activityType === 'all' || activity.type === activityType as ActivityType;
      ...
      <section className="mb-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-[#1f2937] rounded-xl p-6 border border-[#374151]">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <div className="w-8 h-8 rounded-full overflow-hidden mr-3">
                    <img src="https://images.unsplash.com/photo-1599566150163-29194dcaad36?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&h=100&q=80" alt="Collector avatar" className="w-full h-full object-cover" />
                  </div>
                  <div>
                    <p className="text-white text-sm">BitQueen</p>
                    <p className="text-gray-400 text-xs">9 purchases</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <div className="w-8 h-8 rounded-full overflow-hidden mr-3">
                    <img src="https://images.unsplash.com/photo-1607746882042-944635dfe10e?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&h=100&q=80" alt="Collector avatar" className="w-full h-full object-cover" />
                  </div>
                  <div>
                    <p className="text-white text-sm">NFT_Enthusiast</p>
                    <p className="text-gray-400 text-xs">7 purchases</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <div className="w-8 h-8 rounded-full overflow-hidden mr-3">
                    <img src="https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&h=100&q=80" alt="Collector avatar" className="w-full h-full object-cover" />
                  </div>
                  <div>
                    <p className="text-white text-sm">Web3_Wizard</p>
                    <p className="text-gray-400 text-xs">5 purchases</p>
                  </div>
                </div>
                <span className="text-primary font-medium">1.5 ETH</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#1f2937] rounded-xl p-6 border border-[#374151]">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                <div className="h-12 w-12 flex-shrink-0 rounded-md overflow-hidden mr-3">
                  <img src="https://images.unsplash.com/photo-1634986666676-ec9e359c3e45?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&h=100&q=80" alt="NFT thumbnail" className="h-full w-full object-cover" />
                </div>
                <div className="flex-grow">
                  <div className="flex justify-between">
                    <p className="text-white text-sm font-medium">Cosmic Dreams #42</p>
                    <p className="text-primary text-sm">0.5 ETH</p>
                  </div>
                  <div className="flex justify-between">
                    <p className="text-gray-400 text-xs">@stargazer</p>
              ...
              <div className="flex items-center">
                <div className="h-12 w-12 flex-shrink-0 rounded-md overflow-hidden mr-3">
                  <img src="https://images.unsplash.com/photo-1618005198919-d3d4b5a92ead?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&h=100&q=80" alt="NFT thumbnail" className="h-full w-full object-cover" />
                </div>
                <div className="flex-grow">
                  <div className="flex justify-between">
                    <p className="text-white text-sm font-medium">Digital Genesis #18</p>
                    <p className="text-primary text-sm">0.8 ETH</p>
                  </div>
                  <div className="flex justify-between">
                    <p className="text-gray-400 text-xs">@cyberartist</p>
              ...
              <div className="flex items-center">
                <div className="h-12 w-12 flex-shrink-0 rounded-md overflow-hidden mr-3">
                  <img src="https://images.unsplash.com/photo-1622547748225-3fc4abd2cca0?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&h=100&q=80" alt="NFT thumbnail" className="h-full w-full object-cover" />
                </div>
                <div className="flex-grow">
                  <div className="flex justify-between">
                    <p className="text-white text-sm font-medium">Neon Horizon #7</p>
                    <p className="text-primary text-sm">0.3 ETH</p>
                  </div>
                  <div className="flex justify-between">
                    <p className="text-gray-400 text-xs">@futurevisions</p>
                    <p className="text-gray-400 text-xs">8 hours ago</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center">
                <div className="h-12 w-12 flex-shrink-0 rounded-md overflow-hidden mr-3">
                  <img src="https://images.unsplash.com/photo-1633250587603-42e4fd584ed0?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&h=100&q=80" alt="NFT thumbnail" className="h-full w-full object-cover" />
                </div>
                <div className="flex-grow">
                  <div className="flex justify-between">
                    <p className="text-white text-sm font-medium">Quantum Leap #24</p>
                    <p className="text-primary text-sm">0.6 ETH</p>
                  </div>
                  <div className="flex justify-between">
                    <p className="text-gray-400 text-xs">@quantumcreator</p>
